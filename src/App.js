   ...
   <div className={"w-[350px] grid gap-y-3"}>
       <div className={"bg-white border p-[40px] pt-10 pb-6"}>
           ...
           <form className={"grid gap-y-1.5"}>
               ...
               <button type={"submit"} disabled={!enable} className={"h-[30px] mt-1 rounded bg-instagram-button font-medium text-white text-sm disabled:opacity-50"}>Giriş Yap</button>
       ...
       <div className={"bg-white border p-4 text-sm text-center"}>
           Hesabın yok mu? <a href={"#"} className={"font-semibold text-instagram-button"}>Kaydol</a>
       </div>
   </div>
   </div>
  );
